...
| `field-agent-command.test.mjs` | 상시 | active | 실제 HWP 표 셀 exact focus·apply·export/reopen·revert·selection event·modal 0회 | biz_plan.hwp | npm e2e:field-agent | fresh WASM 필수 |
