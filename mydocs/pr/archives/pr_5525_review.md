...
- cherry-pick 충돌은 없었다.
- 검토 문서는 코드 candidate 뒤 별도 commit으로 정리해 `upstream/pr/devel-planet6897-5525-review`
  임시 head에 push했으며, contributor 원 history는 rewrite하지 않았다.
...
보강하는 것을 권고한다. 통합 PR 생성, GitHub review·승인·merge·comment는 수행하지 않았다.
